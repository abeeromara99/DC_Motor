...
u8  DIO_u8SetPinDirection (u8 Copy_u8PortId, u8 Copy_u8PinId ,u8 Copy_u8PinDirection)
{
	...
	if((Copy_u8PortId <= DIO_u8_PORTD) && (Copy_u8PinId <= DIO_u8_PIN7) && ((Copy_u8PinDirection == DIO_u8_PIN_OUTPUT) || (Copy_u8PinDirection == DIO_u8_PIN_INPUT)))
	{
		switch (Copy_u8PortId)
		{
			case DIO_u8_PORTA:
				...
				{
					case DIO_u8_PIN_OUTPUT:SET_BIT(DIO_u8_DDRA_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_INPUT: CLR_BIT(DIO_u8_DDRA_REG,Copy_u8PinId);break;
				}
			break;
			case DIO_u8_PORTB:
				switch (Copy_u8PinDirection)
				{
					case DIO_u8_PIN_OUTPUT:SET_BIT(DIO_u8_DDRB_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_INPUT: CLR_BIT(DIO_u8_DDRB_REG,Copy_u8PinId);break;
				}
			break;
			case DIO_u8_PORTC:
				switch (Copy_u8PinDirection)
				{
					case DIO_u8_PIN_OUTPUT:SET_BIT(DIO_u8_DDRC_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_INPUT: CLR_BIT(DIO_u8_DDRC_REG,Copy_u8PinId);break;
				}
			break;
			case DIO_u8_PORTD:
				switch (Copy_u8PinDirection)
				{
					case DIO_u8_PIN_OUTPUT:SET_BIT(DIO_u8_DDRD_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_INPUT: CLR_BIT(DIO_u8_DDRD_REG,Copy_u8PinId);break;
				}
			break;			
		}
	}
	...
	if(Copy_u8PinId <= DIO_u8_PIN7)
	{
		switch (Copy_u8PortId)
		{
			case DIO_u8_PORTA:
				...
				{
					case DIO_u8_PIN_HIGH:SET_BIT(DIO_u8_PORTA_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_LOW: CLR_BIT(DIO_u8_PORTA_REG,Copy_u8PinId);break;
			...
			case DIO_u8_PORTB:
				switch (Copy_u8PinValue)
				{
					case DIO_u8_PIN_HIGH:SET_BIT(DIO_u8_PORTB_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_LOW: CLR_BIT(DIO_u8_PORTB_REG,Copy_u8PinId);break;
					default : Local_u8ErrorState = STD_TYPES_NOK;
				}		
			break;
			case DIO_u8_PORTC:
				switch (Copy_u8PinValue)
				{
					case DIO_u8_PIN_HIGH:SET_BIT(DIO_u8_PORTC_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_LOW: CLR_BIT(DIO_u8_PORTC_REG,Copy_u8PinId);break;
					default : Local_u8ErrorState = STD_TYPES_NOK;
				}		
			break;
			case DIO_u8_PORTD:
				switch (Copy_u8PinValue)
				{
					case DIO_u8_PIN_HIGH:SET_BIT(DIO_u8_PORTD_REG,Copy_u8PinId);break;
					case DIO_u8_PIN_LOW: CLR_BIT(DIO_u8_PORTD_REG,Copy_u8PinId);break;
					default : Local_u8ErrorState = STD_TYPES_NOK;
				}		
			break;
			default :
...
{
	u8 Local_u8ErrorState = STD_TYPES_OK;
	if((Copy_u8PortDirection == DIO_u8_PORT_OUTPUT) || (Copy_u8PortDirection == DIO_u8_PORT_INPUT))
	{
		switch (Copy_u8PortId)
		{
			case DIO_u8_PORTA:
				...
				{
					case DIO_u8_PORT_OUTPUT:DIO_u8_DDRA_REG = DIO_u8_PORT_OUTPUT;break;
					case DIO_u8_PORT_INPUT :DIO_u8_DDRA_REG = DIO_u8_PORT_INPUT;break;
				}
			break;
			case DIO_u8_PORTB:
				switch (Copy_u8PortDirection)
				{
					case DIO_u8_PORT_OUTPUT:DIO_u8_DDRB_REG = DIO_u8_PORT_OUTPUT;break;
					case DIO_u8_PORT_INPUT :DIO_u8_DDRB_REG = DIO_u8_PORT_INPUT;break;
				}
			break;
			case DIO_u8_PORTC:
				switch (Copy_u8PortDirection)
				{
					case DIO_u8_PORT_OUTPUT:DIO_u8_DDRC_REG = DIO_u8_PORT_OUTPUT;break;
					case DIO_u8_PORT_INPUT :DIO_u8_DDRC_REG = DIO_u8_PORT_INPUT;break;
				}
			break;
			case DIO_u8_PORTD:
				switch (Copy_u8PortDirection)
				{
					case DIO_u8_PORT_OUTPUT:DIO_u8_DDRD_REG = DIO_u8_PORT_OUTPUT;break;
					case DIO_u8_PORT_INPUT :DIO_u8_DDRD_REG = DIO_u8_PORT_INPUT;break;
				}
			break;
			default :Local_u8ErrorState = STD_TYPES_NOK;
		}
